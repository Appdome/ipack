...
public final class EmbeddedSignatureBlob extends SuperBlob<Blob> {
    ...
    public EntitlementsBlob getEntitlementsSubBlob() {
        return (EntitlementsBlob) getSubBlob(2);
    }
    
    public void setEntitlementsSubBlob(
            final EntitlementsBlob entitlementsBlob) {
        setSubBlob(2, SpecialSlotConstants.CD_ENTITLEMENT_SLOT,
                    entitlementsBlob);
    }


    public CodeDirectoryBlob getCodeDirectory256SubBlob() {
        return (CodeDirectoryBlob) getSubBlob(3);
    }

    public void setCodeDirectory256SubBlob(final CodeDirectoryBlob codeDirectory) {
        setSubBlob(3, SpecialSlotConstants.CD_CODE_DIRECTORY_256_SLOT,
                   codeDirectory);
    }
    ...
    public void setSignatureSubBlob(final Blob signatureBlob) {
        setSubBlob(4, SpecialSlotConstants.CD_SIGNATURE_SLOT,
                   signatureBlob);
    }
